...
public class MiniMaxApi {
	 ...
	 * @param reasoningSplit When true, the model separates interleaved reasoning into the reasoning_details field.
	...
	public record ChatCompletionRequest(
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model,
			...
			this(messages, model, null, null, null, null,
					null, null, null, false, 0.8, null, null, null,
					tools, toolChoice);
		}
	 ...
	 * @param reasoningDetails Interleaved reasoning details returned by MiniMax M2.7 when reasoning_split is enabled.
	 */
	@JsonInclude(Include.NON_NULL)
	...
	public record ChatCompletionMessage(
			...
			@JsonProperty("reasoning_details") List<ReasoningDetail> reasoningDetails) {
		...
		/**
		 * Create a chat completion message without reasoning details.
		 * @param content The contents of the message.
		 * @param role The role of the author of this message.
		...
		/**
		 * Interleaved reasoning detail emitted by MiniMax M2.7.
		 *
		 * @param type The reasoning content type.
		 * @param id The reasoning item identifier.
		 * @param format The reasoning payload format.
		 * @param index The reasoning item index.
		 * @param text The reasoning text payload.
		 */
		@JsonInclude(Include.NON_NULL)
		@JsonIgnoreProperties(ignoreUnknown = true)
