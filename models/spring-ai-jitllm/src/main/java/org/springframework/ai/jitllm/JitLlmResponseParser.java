...
/**
 * Parses jitLLM response text into visible content and optional thinking content.
 * <p>
...
final class JitLlmResponseParser {
	...
	ParsedResponse parse(@Nullable String text) {
	...
	/**
	 * Parsed jitLLM response content and optional thinking text.
	 */
	record ParsedResponse(String content, @Nullable String thinking) {
	}
