...
public class MockWeatherService implements Function<MockWeatherService.Request, MockWeatherService.Response> {
	...
	private final List<Request> callHistory = new ArrayList<>();

	@Override
	public Response apply(Request request) {
		// Track function calls
		this.callHistory.add(request);
	...
	/**
	 * Get the history of all function calls.
	 * @return List of all requests received.
	 */
	public List<Request> getCallHistory() {
