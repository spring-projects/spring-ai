...
import static org.springframework.ai.ollama.BaseOllamaIT.initializeOllama;

/**
 * @author Yokior
 */
@SpringBootTest(classes = OllamaEmbeddingOptionsTests.TestConfiguration.class)
public class OllamaEmbeddingOptionsTests {
	...
	void testDimensionsParameterComparison() {
		...
		EmbeddingResponse responseWithoutDimensions = embeddingModel.call(requestWithoutDimensions);
		...
		EmbeddingResponse responseWithDimensions = embeddingModel.call(requestWithDimensions);
