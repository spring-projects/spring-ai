...
public class OpenAiSdkModerationOptions extends AbstractOpenAiSdkOptions implements ModerationOptions {
	...
	public OpenAiSdkModerationOptions copy() {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof OpenAiSdkModerationOptions that)) {
			return false;
		}
	...
	public String toString() {
		return "OpenAiSdkModerationOptions{" + "model='" + this.model + '\'' + ", baseUrl='" + getBaseUrl() + '\''
	...
	public static final class Builder {
		...
		public Builder from(OpenAiSdkModerationOptions options) {
		...
		public Builder merge(@Nullable ModerationOptions options) {
			...
			if (options instanceof OpenAiSdkModerationOptions castFrom) {
		...
		public OpenAiSdkModerationOptions build() {
			OpenAiSdkModerationOptions options = new OpenAiSdkModerationOptions();
