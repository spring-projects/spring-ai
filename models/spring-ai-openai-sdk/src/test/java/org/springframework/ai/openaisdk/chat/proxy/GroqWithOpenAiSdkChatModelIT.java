 ...
 */
@SpringBootTest(classes = GroqWithOpenAiSdkChatModelIT.Config.class)
@EnabledIfEnvironmentVariable(named = "GROQ_API_KEY", matches = ".+")
class GroqWithOpenAiSdkChatModelIT {

	private static final Logger logger = LoggerFactory.getLogger(GroqWithOpenAiSdkChatModelIT.class);
