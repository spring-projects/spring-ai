 ...
 */
@SpringBootTest(classes = DeepSeekWithOpenAiSdkChatModelIT.Config.class)
@EnabledIfEnvironmentVariable(named = "DEEPSEEK_API_KEY", matches = ".+")
class DeepSeekWithOpenAiSdkChatModelIT {

	private static final Logger logger = LoggerFactory.getLogger(DeepSeekWithOpenAiSdkChatModelIT.class);
