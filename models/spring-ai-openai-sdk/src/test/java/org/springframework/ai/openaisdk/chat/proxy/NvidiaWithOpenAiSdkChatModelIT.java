 ...
 */
@SpringBootTest(classes = NvidiaWithOpenAiSdkChatModelIT.Config.class)
@EnabledIfEnvironmentVariable(named = "NVIDIA_API_KEY", matches = ".+")
@Disabled("Requires NVIDIA credits")
class NvidiaWithOpenAiSdkChatModelIT {

	private static final Logger logger = LoggerFactory.getLogger(NvidiaWithOpenAiSdkChatModelIT.class);
