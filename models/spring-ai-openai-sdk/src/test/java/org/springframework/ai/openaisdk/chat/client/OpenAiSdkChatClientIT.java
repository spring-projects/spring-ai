...
import org.springframework.ai.openaisdk.chat.MockWeatherService;
...
class OpenAiSdkChatClientIT {

	private static final Logger logger = LoggerFactory.getLogger(OpenAiSdkChatClientIT.class);
	...
	@Autowired
	protected OpenAiSdkChatModel openAiChatModel;
