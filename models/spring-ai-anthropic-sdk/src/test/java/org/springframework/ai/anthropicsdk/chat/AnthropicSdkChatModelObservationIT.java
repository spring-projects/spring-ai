...
/**
 * Integration tests for observation instrumentation in {@link AnthropicSdkChatModel}.
 *
 * @author Soby Chacko
 */
@SpringBootTest(classes = AnthropicSdkChatModelObservationIT.Config.class)
...
public class AnthropicSdkChatModelObservationIT {
	...
	@Autowired
	AnthropicSdkChatModel chatModel;
