...
public class ZhiPuAiEmbeddingClient extends AbstractEmbeddingClient {
	...
	private static final Logger logger = LoggerFactory.getLogger(ZhiPuAiEmbeddingClient.class);
	...
	/**
	 * Constructor for the ZhiPuAiEmbeddingClient class.
	...
	/**
	 * Initializes a new instance of the ZhiPuAiEmbeddingClient class.
	 * @param zhiPuAiApi The ZhiPuAiApi instance to use for making API requests.
