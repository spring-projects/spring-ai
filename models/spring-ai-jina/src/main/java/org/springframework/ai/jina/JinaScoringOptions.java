...
public final class JinaScoringOptions implements ScoringOptions {
	 ...
	 */
	public void setModel(final @Nullable String name) {
		this.modelName = name;
	}
	 ...
	 * @param value value
	 */
	public void setTopK(final @Nullable Integer value) {
	 ...
	 * @param enabled flag
	 */
	public void setReturnDocuments(final @Nullable Boolean enabled) {
	 ...
	 * @param enabled flag
	 */
	public void setTruncation(final @Nullable Boolean enabled) {
	...
	public static final class Builder {
		 ...
		 * @return builder
		 */
		public Builder model(final @Nullable String name) {
		 ...
		 * @return builder
		 */
		public Builder topK(final @Nullable Integer value) {
		 ...
		 * @return builder
		 */
		public Builder returnDocuments(final @Nullable Boolean enabled) {
		 ...
		 * @return builder
		 */
		public Builder truncation(final @Nullable Boolean enabled) {
