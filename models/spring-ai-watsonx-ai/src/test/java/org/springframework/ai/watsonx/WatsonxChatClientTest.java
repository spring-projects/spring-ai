...
public class WatsonxChatClientTest {
    ...
    public void testCallMethod() {
        ...
        Prompt prompt = new Prompt(
                List.of(new SystemMessage("Your prompt here")),
                WatsonxAIOptions.create().withModel("google/flan-ul2")
        );

        WatsonxAIOptions parameters = WatsonxAIOptions.create()
                .withModel("google/flan-ul2");

        WatsonxAIResults fakeResults = new WatsonxAIResults(
                "LLM response",
                4,
                3,
                "max_tokens"
        ...
        WatsonxAIResponse fakeResponse = new WatsonxAIResponse(
                "google/flan-ul2",
                new Date(),
                List.of(fakeResults),
    ...
    public void testStreamMethod() {
        ...
        WatsonxAIResults fakeResultsFirst = new WatsonxAIResults(
                "LLM resp",
                0,
                0,
                "max_tokens"
        );
        WatsonxAIResults fakeResultsSecond = new WatsonxAIResults(
                "onse",
                4,
                3,
                "not_finished"
        ...
        WatsonxAIResponse fakeResponseFirst = new WatsonxAIResponse(
                "google/flan-ul2",
                new Date(),
                List.of(fakeResultsFirst),
                Map.of("warnings", List.of(Map.of("message", "the message", "id", "disclaimer_warning")))
        );
        WatsonxAIResponse fakeResponseSecond = new WatsonxAIResponse(
                "google/flan-ul2",
                new Date() ,
                List.of(fakeResultsSecond),
                null
        );
