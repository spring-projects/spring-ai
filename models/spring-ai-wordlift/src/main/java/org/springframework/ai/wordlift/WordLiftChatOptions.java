...
import org.springframework.ai.wordlift.api.WordLiftApi.ChatCompletionRequest.ResponseFormat;
import org.springframework.ai.wordlift.api.WordLiftApi.ChatCompletionRequest.StreamOptions;
import org.springframework.ai.wordlift.api.WordLiftApi.ChatCompletionRequest.ToolChoiceBuilder;
import org.springframework.ai.wordlift.api.WordLiftApi.FunctionTool;
...
public class WordLiftChatOptions
  ...
  public static class Builder {
    ...
    protected WordLiftChatOptions options;

    public Builder() {
      this.options = new WordLiftChatOptions();
    }

    public Builder(WordLiftChatOptions options) {
    ...
    public Builder withModel(WordLiftApi.ChatModel openAiChatModel) {
    ...
    public Builder withStreamUsage(boolean enableStreamUsage) {
      this.options.streamOptions =
        (enableStreamUsage) ? StreamOptions.INCLUDE_USAGE : null;
      return this;
    }
    ...
    public WordLiftChatOptions build() {
      return this.options;
    }
  }
  ...
  public int hashCode() {
    ...
    result =
      prime * result + ((topLogprobs == null) ? 0 : topLogprobs.hashCode());
    ...
    result =
      prime * result + ((streamOptions == null) ? 0 : streamOptions.hashCode());
    ...
    result =
      prime * result + ((toolChoice == null) ? 0 : toolChoice.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    WordLiftChatOptions other = (WordLiftChatOptions) obj;
    if (this.model == null) {
    ...
    if (this.frequencyPenalty == null) {
      ...
      !this.frequencyPenalty.equals(other.frequencyPenalty)
    ) return false;
    ...
    if (this.presencePenalty == null) {
      ...
      !this.presencePenalty.equals(other.presencePenalty)
    ) return false;
    ...
    if (this.streamOptions == null) {
      if (other.streamOptions != null) return false;
    } else if (!this.streamOptions.equals(other.streamOptions)) return false;
    if (this.seed == null) {
    ...
    } else if (!this.user.equals(other.user)) return false; else if (
      this.parallelToolCalls == null
    ) {
      if (other.parallelToolCalls != null) return false;
    } else if (
      !this.parallelToolCalls.equals(other.parallelToolCalls)
    ) return false;
  ...
  @Override
  public WordLiftChatOptions copy() {
    return WordLiftChatOptions.fromOptions(this);
  }

  public static WordLiftChatOptions fromOptions(
    WordLiftChatOptions fromOptions
  ) {
    return WordLiftChatOptions
      .builder()
