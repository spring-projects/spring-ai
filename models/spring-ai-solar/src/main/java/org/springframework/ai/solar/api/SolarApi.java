...
public class SolarApi {
	 ...
	 */
	public SolarApi(String baseUrl, String apiKey, RestClient.Builder restClientBuilder, ResponseErrorHandler responseErrorHandler) {
	...
	public record ChatCompletionRequest(
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, boolean stream) {
			this(messages, null, model, null, null,
	...
	public record ChatCompletionChunk(
			...
			@JsonProperty("usage") Usage usage,
			@JsonProperty("system_finger_print") String systemFingerPrint
	) {
		public record Choice(
				@JsonProperty("index") int index,
	...
	public record EmbeddingRequest(
		 ...
		 * @param text Input text to embed.
		 * @param model ID of the model to use.
		 * @param userId A unique identifier representing your end-user, which can help Solar to
		 * 		monitor and detect abuse.
		 */
