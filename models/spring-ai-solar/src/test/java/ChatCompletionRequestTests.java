...
public class ChatCompletionRequestTests {
	...
	public void createRequestWithChatOptions() {
		var client = new SolarChatModel(new SolarApi("TEST", "TEST"),
				SolarChatOptions.builder().withModel("DEFAULT_MODEL").withTemperature(66.6).build());
		...
		request = client.createRequest(new Prompt("Test message content",
				SolarChatOptions.builder().withModel("PROMPT_MODEL").withTemperature(99.9).build()), true);
