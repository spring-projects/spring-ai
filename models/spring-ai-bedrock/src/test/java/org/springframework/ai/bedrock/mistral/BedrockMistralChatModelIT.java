...
public class BedrockMistralChatModelIT {

	private static final Logger logger = LoggerFactory.getLogger(BedrockMistralChatModelIT.class);

	@Autowired
	private BedrockMistralChatModel chatModel;
	...
	public static class TestConfiguration {
		...
		public BedrockMistralChatModel mistralChatModel(BedrockConverseApi converseApi) {
			return new BedrockMistralChatModel(converseApi);
		}
