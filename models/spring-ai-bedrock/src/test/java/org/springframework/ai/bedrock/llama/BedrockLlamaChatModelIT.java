...
class BedrockLlamaChatModelIT {
	...
	@Test
	void chatOptions() {
		BedrockLlamaChatOptions options = BedrockLlamaChatOptions.builder()
	...
	public static class TestConfiguration {
		...
		@Bean
		public BedrockLlamaChatModel llamaChatModel(BedrockConverseApi converseApi) {
			return new BedrockLlamaChatModel(converseApi,
