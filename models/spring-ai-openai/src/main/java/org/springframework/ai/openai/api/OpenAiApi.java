...
public class OpenAiApi {
	...
	public static class ChatCompletionRequest extends OpenAiChatOptions {
		 ...
		 */
		private @JsonProperty("messages") List<ChatCompletionMessage> messages;
		...
		public static ChatCompletionRequest from(List<ChatCompletionMessage> messages, OpenAiChatOptions options, boolean stream) {
