...
public class OpenAiApi {
	...
	public record FunctionTool(// @formatter:off
		 ...
		 * @param strict Whether to enable strict schema adherence when generating the function call. If set to true,
		 * the model will follow the exact schema defined in the parameters field. Only a subset of JSON Schema
	...
	public record ChatCompletionRequest(// @formatter:off
		...
		public ChatCompletionRequest withStreamOptions(StreamOptions streamOptions) {
			return new ChatCompletionRequest(messages, model, store, metadata, frequencyPenalty, logitBias, logprobs,
					topLogprobs, maxTokens, maxCompletionTokens, n, outputModalities, audioParameters, presencePenalty,
					responseFormat, seed, serviceTier, stop, stream, streamOptions, temperature, topP,
...
// @formatter:on
			 ...
			 */
			@JsonInclude(Include.NON_NULL)
			public record InputAudio(@JsonProperty("data") String data, @JsonProperty("format") Format format) {
				public enum Format {
	...
	public record Usage(// @formatter:off
		 ...
		 */
		@JsonInclude(Include.NON_NULL)
		public record PromptTokenDetails(// @formatter:off
				@JsonProperty("audio_tokens") Integer audioTokens,
