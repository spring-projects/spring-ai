...
public class VertexAiPaLm2ApiTests {
	...
	public void embedText() throws JsonProcessingException {
		...
		Embedding expectedEmbedding = new Embedding(List.of(0.1f, 0.2f, 0.3f));
	...
	public void batchEmbedText() throws JsonProcessingException {
		...
		List<Embedding> expectedEmbeddings = List.of(new Embedding(List.of(0.1f, 0.2f, 0.3f)),
				new Embedding(List.of(0.4f, 0.5f, 0.6f)));
