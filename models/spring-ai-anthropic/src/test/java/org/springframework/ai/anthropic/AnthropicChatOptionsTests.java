...
class AnthropicChatOptionsTests {
	...
	void testCacheStrategyDefaultValue() {
		...
		assertThat(options.getCacheOptions().getMessageTypeTtls().values())
	...
	void testCacheStrategyCopy() {
		...
		assertThat(copied.getCacheOptions().getMessageTypeTtls())
			.isEqualTo(original.getCacheOptions().getMessageTypeTtls());
	}
	...
	void testBuilderWithAllFieldsIncludingCacheStrategy() {
		...
		assertThat(options.getCacheOptions().getMessageTypeTtls().get(MessageType.SYSTEM))
	...
	void testCacheStrategyMutationDoesNotAffectOriginal() {
		...
		var modifiedCacheOptions = AnthropicCacheOptions.builder()
			...
			.messageTypeTtls(MessageType.SYSTEM, AnthropicCacheTtl.FIVE_MINUTES)
			.build();
		...
		assertThat(original.getCacheOptions().getMessageTypeTtls().get(MessageType.SYSTEM))
			.isEqualTo(AnthropicCacheTtl.ONE_HOUR);

		// Copy should have modified values
		assertThat(copy.getCacheOptions().getStrategy()).isEqualTo(AnthropicCacheStrategy.NONE);
		assertThat(copy.getCacheOptions().getMessageTypeTtls().get(MessageType.SYSTEM))
