...
public class AnthropicCacheOptions {
	 ...
	 */
	private Map<MessageType, AnthropicCacheTtl> messageTypeTtls = Stream.of(MessageType.values())
	...
	public Map<MessageType, AnthropicCacheTtl> getMessageTypeTtls() {
		return this.messageTypeTtls;
	}

	public void setMessageTypeTtls(Map<MessageType, AnthropicCacheTtl> messageTypeTtls) {
		this.messageTypeTtls = messageTypeTtls;
	}
	...
	public String toString() {
		return "AnthropicCacheOptions{" + "strategy=" + this.strategy + ", contentLengthFunction="
				+ this.contentLengthFunction + ", messageTypeTtls=" + this.messageTypeTtls
	...
	public static class Builder {
		...
		public Builder messageTypeTtls(Map<MessageType, AnthropicCacheTtl> messageTypeTtls) {
			this.options.setMessageTypeTtls(messageTypeTtls);
			return this;
		}

		public Builder messageTypeTtls(MessageType messageType, AnthropicCacheTtl ttl) {
			this.options.messageTypeTtls.put(messageType, ttl);
			return this;
		}
