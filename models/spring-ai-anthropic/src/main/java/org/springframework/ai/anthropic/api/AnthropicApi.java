...
public class AnthropicApi {
	...
	public enum ChatModel implements ChatModelDescription {
		...
		/**
		 * The latest Claude 3.5 Sonnet model.
		 */
	...
	public enum EventType {
		...
		/**
		 * When using extended thinking with streaming enabled, you’ll receive thinking
		 * content via thinking_delta events. These deltas correspond to the thinking
		 * field of the thinking content blocks.
		 */
		 ...
		 * content_block_stop event. This signature is used to verify the integrity of the
		 * thinking block.
		 */
