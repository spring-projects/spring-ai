...
public class CacheEligibilityResolver {
	...
	private final Map<MessageType, AnthropicCacheTtl> messageTypeTtls;
	...
	public CacheEligibilityResolver(AnthropicCacheStrategy cacheStrategy,
			Map<MessageType, AnthropicCacheTtl> messageTypeTtls, Map<MessageType, Integer> messageTypeMinContentLengths,
	...
	public static CacheEligibilityResolver from(AnthropicCacheOptions anthropicCacheOptions) {
		...
		return new CacheEligibilityResolver(strategy, anthropicCacheOptions.getMessageTypeTtls(),
	...
	public AnthropicApi.ChatCompletionRequest.CacheControl resolve(MessageType messageType, String content) {
		...
		AnthropicCacheTtl anthropicCacheTtl = this.messageTypeTtls.get(messageType);
	...
	public AnthropicApi.ChatCompletionRequest.CacheControl resolveToolCacheControl() {
		...
		AnthropicCacheTtl anthropicCacheTtl = this.messageTypeTtls.get(TOOL_DEFINITION_MESSAGE_TYPE);
