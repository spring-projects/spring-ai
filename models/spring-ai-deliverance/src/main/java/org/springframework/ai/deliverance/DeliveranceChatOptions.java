...
public final class DeliveranceChatOptions implements ToolCallingChatOptions {
	...
	private final @Nullable Double uniformTopP;
	...
	private DeliveranceChatOptions(Builder builder) {
		...
		this.uniformTopP = builder.uniformTopP;
	...
	public @Nullable Double getUniformTopP() {
		return this.uniformTopP;
	}
	...
	public static final class Builder implements ToolCallingChatOptions.Builder<Builder> {
		...
		private @Nullable Double uniformTopP;
		...
		public Builder uniformTopP(@Nullable Double uniformTopP) {
			this.uniformTopP = uniformTopP;
			return this;
		}
		...
		public Builder combineWith(org.springframework.ai.chat.prompt.ChatOptions.Builder<?> other) {
			...
			if (options instanceof DeliveranceChatOptions deliveranceOptions
				...
				this.uniformTopP = deliveranceOptions.getUniformTopP();
			}
