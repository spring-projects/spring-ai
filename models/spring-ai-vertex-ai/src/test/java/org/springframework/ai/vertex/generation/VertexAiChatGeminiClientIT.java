...
@SpringBootTest
class VertexAiChatGeminiClientIT {

	@Autowired
	private VertexAiGeminiClient client;
	...
	public static class TestConfiguration {
		...
		public VertexAI vertexAI() {
			String projectId = System.getenv("VERTEX_AI_PROJECT_ID");
			String location = System.getenv("VERTEX_AI_LOCATION");
			try {
		...
		@Bean
		public VertexAiGeminiClient geminiClient(VertexAI vertexAI) {
			return new VertexAiGeminiClient(vertexAI, null);
		}
