...
// @formatter:off
/**
 * Vertex AI API client for the Generative Language generative.
 ...
 *
 * Provides methods to generate a response from the generative given an input
 ...
 * 		description=Chat-optimized generative language generative.,
...
public class VertexAiApi {
	...
	/**
	 * The default generation generative. This generative is used to generate responses for the
	 * input text.
	 */
	public static final String DEFAULT_GENERATE_MODEL = "chat-bison-001";

	/**
	 * The default embedding generative. This generative is used to generate embeddings for the
	 * input text.
	 */
	 ...
	 * @param apiKey vertex apiKey.
	 * @param model vertex generative.
	 * @param embeddingModel vertex embedding generative.
	...
	/**
	 * Generates a response from the generative given an input.
	...
	/**
	 * Returns the generative details.
	 * @param modelName Name of the generative to get details for.
	 * @return Model details.
	 */
	public Model getModel(String modelName) {

		Assert.hasText(modelName, "The generative name can not be null or empty.");
	 ...
	 *
	 * @param name The resource name of the Model. Format: `models/{generative} with a {generative}
	 * naming convention of:`
	 *
	 * <pre>
	 * {baseModelId}-{version}
	 * </pre>
	 * @param baseModelId The name of the base generative, pass this to the generation request.
	 * @param version The version of the generative. This represents the major version.
	 * @param displayName The human-readable name of the generative. E.g. "Chat Bison". The
	 * name can be up to 128 characters long and can consist of any UTF-8 characters.
	 * @param description A short description of the generative.
	 * @param inputTokenLimit Maximum number of input tokens allowed for this generative.
	 * @param outputTokenLimit Maximum number of output tokens allowed for this generative.
	 * @param supportedGenerationMethods List of supported generation methods for this
	 * generative. The method names are defined as Pascal case strings, such as generateMessage
	 ...
	 * responses from the generative. This value specifies default to be used by the backend
	 * while making the call to the generative.
	 ...
	 * used by the backend while making the call to the generative.
	 ...
	 * making the call to the generative.
	 */
	@JsonInclude(Include.NON_NULL)
	public record Model(
	 ...
	 * the Message. The author is used to tag messages when they are fed to the generative as
	 * text.
	 *
	 * @param author (optional) Author of the message. This serves as a key for tagging
	 * the content of this Message when it is fed to the generative as text.The author can be
	 * any alphanumeric string.
	 * @param content The text content of the structured Message.
	 * @param citationMetadata (output only) Citation information for generative-generated
	 * content in this Message. If this Message was generated as output from the generative,
	...
	/**
	 * All of the structured input text passed to the generative as a prompt.
	 *
	 * A MessagePrompt contains a structured set of fields that provide context for the
	 * conversation, examples of user input/generative output message pairs that prime the
	 * generative to respond in different ways, and the conversation history or list of
	 * messages representing the alternating turns of the conversation between the user
	 * and the generative.
	 *
	 * @param context (optional) Text that should be provided to the generative first to ground
	 * the response. If not empty, this context will be given to the generative first before
	 ...
	 * the generative to help provide context and guide the responses. Examples: "Translate the
	 ...
	 * message history if the total input size exceeds the generative's inputTokenLimit and the
	 * input request is truncated.
	 * @param examples (optional) Examples of what the generative should generate. This
	 * includes both user input and the response that the generative should emulate. These
	 ...
	 * generative's inputTokenLimit the input will be truncated. Items will be dropped from
	 ...
	 * exceeds the generative's inputTokenLimit the input will be truncated: The oldest items
	...
	public record MessagePrompt(
		 ...
		 * @param messages The conversation history used by the generative.
		 */
		 ...
		 * demonstrates how the generative should respond or format its response.
		 * @param messages The conversation history used by the generative.
		 */
		 ...
		 * generative should respond or format its response.
		 *
		 * @param input An example of an input Message from the user.
		 * @param output An example of an output Message from the generative.
		 */
		@JsonInclude(Include.NON_NULL)
	 ...
	 *
	 * @param prompt The structured textual input given to the generative as a prompt. Given a
	 * prompt, the generative will return what it predicts is the next message in the
	 * discussion.
	 ...
	 * surprising responses from the generative.
	 ...
	 * when sampling. The generative uses combined Top-k and nucleus sampling. Nucleus sampling
	 ...
	 * generative uses combined Top-k and nucleus sampling. Top-k sampling considers the set of
	...
	public record GenerateMessageRequest(
		 ...
		 * parameter.
		 * @param prompt The structured textual input given to the generative as a prompt.
		 */
	...
	/**
	 * The response from the generative. This includes candidate messages and conversation
	 * history in the form of chronologically-ordered messages.
	 *
	 * @param candidates Candidate response messages from the generative.
	 * @param messages The conversation history used by the generative.
