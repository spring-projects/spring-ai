...
public class OpenAiOfficialImageModel implements ImageModel {
	...
	/**
	 * Creates a new OpenAiOfficialImageModel with the given options and observation
	 * registry.
	 * @param options the image options
	 * @param observationRegistry the observation registry
	 */
	...
	/**
	 * Creates a new OpenAiOfficialImageModel with the given OpenAI client and observation
	 * registry.
	 * @param openAIClient the OpenAI client
	 * @param observationRegistry the observation registry
	 */
