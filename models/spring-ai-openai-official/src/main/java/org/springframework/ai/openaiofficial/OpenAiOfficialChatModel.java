...
public class OpenAiOfficialChatModel implements ChatModel {
	...
	/**
	 * Creates a new OpenAiOfficialChatModel with the given options and observation
	 * registry.
	 * @param options the chat options
	...
	/**
	 * Creates a new OpenAiOfficialChatModel with the given options, tool calling manager,
	...
	/**
	 * Creates a new OpenAiOfficialChatModel with the given OpenAI clients, options, and
