...
public class OpenAiOfficialChatModel implements ChatModel {
    ...
    /**
     * Creates a new OpenAiOfficialChatModel with default options.
     */
    ...
    /**
     * Creates a new OpenAiOfficialChatModel with the given options.
    ...
    /**
     * Creates a new OpenAiOfficialChatModel with the given options and observation registry.
     * @param options the chat options
    ...
    /**
     * Creates a new OpenAiOfficialChatModel with the given options, tool calling manager, and observation registry.
     * @param options the chat options
    ...
    /**
     * Creates a new OpenAiOfficialChatModel with the given OpenAI clients.
    ...
    /**
     * Creates a new OpenAiOfficialChatModel with the given OpenAI clients and options.
     * @param openAIClient the synchronous OpenAI client
     * @param openAiClientAsync the asynchronous OpenAI client
     * @param options the chat options
     */
    ...
    /**
     * Creates a new OpenAiOfficialChatModel with the given OpenAI clients, options, and observation registry.
     * @param openAIClient the synchronous OpenAI client
     * @param openAiClientAsync the asynchronous OpenAI client
     * @param options the chat options
     * @param observationRegistry the observation registry
    ...
    /**
     * Creates a new OpenAiOfficialChatModel with all configuration options.
     * @param openAiClient the synchronous OpenAI client
     * @param openAiClientAsync the asynchronous OpenAI client
     * @param options the chat options
     * @param toolCallingManager the tool calling manager
     * @param observationRegistry the observation registry
     * @param toolExecutionEligibilityPredicate the predicate to determine tool execution eligibility
     */
    public OpenAiOfficialChatModel(OpenAIClient openAiClient, OpenAIClientAsync openAiClientAsync,
    ...
    /**
     * Response format (text, json_object, json_schema) for OpenAiOfficialChatModel
     * responses.
     *
     * @author Julien Dubois
     */
