...
/**
 * SQL Server dialect for batch execution repository.
 *
 * @author Yasin Akbas
 * @since 2.0.0
 */
public class SqlServerBatchExecutionRepositoryDialect implements JdbcBatchExecutionRepositoryDialect {

	@Override
	public String getUpsertSql() {
		return """
				MERGE INTO SPRING_AI_BATCH_EXECUTION WITH (HOLDLOCK) AS target
