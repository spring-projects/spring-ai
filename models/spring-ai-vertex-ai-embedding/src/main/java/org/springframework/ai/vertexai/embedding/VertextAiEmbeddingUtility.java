...
public class VertextAiEmbeddingUtility {
	...
	public static class TextParametersBuilder {
		...
		public static TextParametersBuilder of() {
			var builder = new TextParametersBuilder();
			return builder;
		}
	...
	public static class ImageBuilder {
		...
		public ImageBuilder withImageData(Object imageData) {
			...
			if (imageData instanceof byte[] imageBytes) {
				return withImageBytes(imageBytes);
			}
			else if (imageData instanceof String gcsUri) {
				return withGcsUri(gcsUri);
			}
			else {
		...
		public Struct build() {
			...
			if (this.mimeType != null) {
				imageBuilder.putFields("mimeType", valueOf((String) this.mimeType.toString()));
			}
	...
	public static class VideoBuilder {
		...
		public Struct build() {
			...
			if (this.mimeType != null) {
				videoBuilder.putFields("mimeType", valueOf((String) this.mimeType.toString()));
			}
