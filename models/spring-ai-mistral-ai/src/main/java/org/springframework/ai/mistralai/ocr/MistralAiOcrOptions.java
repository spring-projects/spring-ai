...
public class MistralAiOcrOptions implements ModelOptions {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(model, that.model) && Objects.equals(id, that.id) && Objects.equals(pages, that.pages)
				&& Objects.equals(includeImageBase64, that.includeImageBase64)
				&& Objects.equals(imageLimit, that.imageLimit) && Objects.equals(imageMinSize, that.imageMinSize);
	}

	@Override
	public int hashCode() {
		return Objects.hash(model, id, pages, includeImageBase64, imageLimit, imageMinSize);
	}
