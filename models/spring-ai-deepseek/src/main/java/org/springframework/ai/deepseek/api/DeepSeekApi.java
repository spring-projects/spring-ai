...
public class DeepSeekApi {
	...
	public static final DeepSeekApi.ChatModel DEFAULT_CHAT_MODEL = ChatModel.DEEPSEEK_FLASH;
	...
	public enum ChatModel implements ChatModelDescription {
		...
		/**
		 * DeepSeek Flash model: the current default, vision-capable chat model.
		 */
		 ...
		 * content generated by deepseek-reasoner, enabling users to view, display, and
		 * distill it.
		 * @deprecated DeepSeek has announced this legacy model name will be deprecated.
		 * Prefer {@link #DEEPSEEK_FLASH} with provider-specific reasoning configuration.
		 */
		@Deprecated(since = "2.0.0")
	...
	public record ChatCompletionRequest(// @formatter:off
		 ...
		 * For normal requests,
		 * {@link ReasoningEffort#HIGH} is the default;
		 * for complex Agent-style requests
	 ...
	 *
	 * @param content The contents of the message. Can be a {@link String} or a list of
	 * {@link ContentChunk} for multimodal messages.
	...
	public record ChatCompletionMessage(// @formatter:off
		...
		/**
		 * An image URL content chunk.
		 *
		 * @param imageUrl The image URL of the chunk.
		 */
		@JsonInclude(Include.NON_NULL)
		@JsonIgnoreProperties(ignoreUnknown = true)
		...
		// @formatter:off
			 ...
			 *
			 * @param url The image URL, either an http(s) URL or a data URI for
		...
		/**
		 * Serializer for the message content, which can be either a plain {@link String}
		 * or a list of {@link ContentChunk}.
		 */
		...
		/**
		 * Deserializer for the message content, which can be either a plain
		 * {@link String} or a list of {@link ContentChunk}.
		 */
