...
public class DeepSeekApiIT {
	...
	void chatCompletionEntity() {
		...
		ResponseEntity<ChatCompletion> response = DeepSeekApi.chatCompletionEntity(
				new ChatCompletionRequest(List.of(chatCompletionMessage), ChatModel.DEEPSEEK_CHAT.value, 1F, false));
	...
	void chatCompletionStream() {
		...
		Flux<ChatCompletionChunk> response = DeepSeekApi.chatCompletionStream(
				new ChatCompletionRequest(List.of(chatCompletionMessage), ChatModel.DEEPSEEK_CHAT.value, 1F, true));
