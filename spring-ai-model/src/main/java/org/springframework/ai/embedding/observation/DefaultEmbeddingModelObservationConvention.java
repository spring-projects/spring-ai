...
public class DefaultEmbeddingModelObservationConvention implements EmbeddingModelObservationConvention {
	 ...
	 * @since 2.1.0
	 */
	protected KeyValues errorType(KeyValues keyValues, EmbeddingModelObservationContext context) {
		...
		return keyValues.and(EmbeddingModelObservationDocumentation.HighCardinalityKeyNames.ERROR_TYPE.asString(),
