...
public class DefaultUsageTests {
	...
	void testDeserializationWithAllFields() throws Exception {
		...
		DefaultUsage usage = this.jsonMapper.readValue(json, DefaultUsage.class);
	...
	void testRoundTripSerialization() throws Exception {
		...
		String json = this.jsonMapper.writeValueAsString(original);
		DefaultUsage deserialized = this.jsonMapper.readValue(json, DefaultUsage.class);
	...
	void testTwoArgumentConstructorAndSerialization() throws Exception {
		...
		DefaultUsage deserializedUsage = this.jsonMapper.readValue(json, DefaultUsage.class);
