...
class GoogleGenAiImageAutoConfigurationIT {
	...
	void imageGenerationWithApiKey() {
		ApplicationContextRunner contextRunner = new ApplicationContextRunner()
			.withPropertyValues("spring.ai.google.genai.image.api-key=" + System.getenv("GOOGLE_API_KEY"),
					"spring.ai.google.genai.image.options.model=imagen-4.0-fast-generate-001",
					"spring.ai.google.genai.image.options.n=1")
	...
	void imageGenerationWithVertexAi() {
		ApplicationContextRunner contextRunner = new ApplicationContextRunner()
	...
	void imageModelActivation() {
		...
		// Disabled
		contextRunner.withConfiguration(AutoConfigurations.of(GoogleGenAiImageAutoConfiguration.class))
