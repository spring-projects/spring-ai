...
import org.springframework.ai.google.genai.image.GoogleGenAiImageModelName;
...
public class GoogleGenAiImageProperties {
	...
	public static final String DEFAULT_MODEL = GoogleGenAiImageModelName.IMAGEN_4_0_GENERATE.getValue();

	/**
	 * Google GenAI Image API options.
	 */
	@NestedConfigurationProperty
	private final GoogleGenAiImageOptions options = GoogleGenAiImageOptions.builder()
		.model(DEFAULT_MODEL)
		.aspectRatio(GoogleGenAiImageOptions.DEFAULT_ASPECT_RATIO)
		.build();
