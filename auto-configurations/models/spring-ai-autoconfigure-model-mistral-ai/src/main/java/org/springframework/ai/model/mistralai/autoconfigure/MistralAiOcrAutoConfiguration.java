...
public class MistralAiOcrAutoConfiguration {
	...
	MistralOcrApi mistralOcrApi(MistralAiCommonProperties commonProperties, MistralAiOcrProperties ocrProperties,
		...
		var resolvedApiKey = MistralAiPropertiesUtils.resolveApiKey(commonProperties, ocrProperties);
		var resolvedBaseUrl = MistralAiPropertiesUtils.resolveBaseUrl(commonProperties, ocrProperties);
