...
public class MistralAiChatAutoConfiguration {
	...
	private static MistralAiApi mistralAiApi(MistralAiCommonProperties commonProperties,
		...
		var resolvedApiKey = MistralAiPropertiesUtils.resolveApiKey(commonProperties, chatProperties);
		var resolvedBaseUrl = MistralAiPropertiesUtils.resolveBaseUrl(commonProperties, chatProperties);
