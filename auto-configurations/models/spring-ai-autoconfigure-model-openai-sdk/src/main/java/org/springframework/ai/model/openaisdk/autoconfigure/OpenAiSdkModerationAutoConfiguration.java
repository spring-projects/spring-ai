 ...
 */
@AutoConfiguration
@EnableConfigurationProperties({ OpenAiSdkConnectionProperties.class, OpenAiSdkModerationProperties.class })
@ConditionalOnProperty(name = SpringAIModelProperties.MODERATION_MODEL, havingValue = SpringAIModels.OPENAI_SDK,
		matchIfMissing = true)
public class OpenAiSdkModerationAutoConfiguration {

	@Bean
	@ConditionalOnMissingBean
	public OpenAiSdkModerationModel openAiSdkModerationModel(OpenAiSdkConnectionProperties commonProperties,
			OpenAiSdkModerationProperties moderationProperties) {
		...
		return OpenAiSdkModerationModel.builder()
