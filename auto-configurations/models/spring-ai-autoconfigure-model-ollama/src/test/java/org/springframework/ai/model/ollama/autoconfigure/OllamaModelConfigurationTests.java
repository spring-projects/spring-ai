...
class OllamaModelConfigurationTests {
	...
	private static final ApplicationContextRunner API_CONTEXT_RUNNER = createApiApplicationContextRunner();
	...
	private static ApplicationContextRunner createApiApplicationContextRunner() {
		var autoConfigurations = AutoConfigurations.of(OllamaApiAutoConfiguration.class);
