...
import org.springframework.ai.mcp.server.stateless.autoconfigure.McpServerStatelessAutoConfiguration;
...
public class StatelessWebClientAndWebFluxServerIT {
	...
	private final ApplicationContextRunner serverContextRunner = new ApplicationContextRunner()
		.withConfiguration(AutoConfigurations.of(McpServerStatelessAutoConfiguration.class,
				ToolCallbackConverterAutoConfiguration.class, McpServerStatelessWebFluxAutoConfiguration.class));
