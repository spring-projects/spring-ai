...
/**
 * A {@link FactoryBean} that creates {@link McpSyncClient} instances for named MCP
 * connections.
 *
 * <p>
 ...
 *
 * <p>
 * Client creation is delegated to {@link McpSyncClientFactory} to ensure consistent
 * configuration with clients created by {@link McpClientAutoConfiguration}.
 *
 * @author Taewoong Kim
 * @see McpConnectionBeanRegistrar
 * @see McpSyncClientFactory
...
public class NamedMcpSyncClientFactoryBean implements FactoryBean<McpSyncClient> {
	...
	private McpSyncClientFactory mcpSyncClientFactory;

	private ObjectProvider<List<NamedClientMcpTransport>> transportsProvider;

	private McpSyncClient cachedClient;
	...
	@Autowired
	public void setMcpSyncClientFactory(McpSyncClientFactory mcpSyncClientFactory) {
		this.mcpSyncClientFactory = mcpSyncClientFactory;
	}
	...
	@Override
	public McpSyncClient getObject() throws Exception {
		...
		this.cachedClient = this.mcpSyncClientFactory.createClient(namedTransport);
