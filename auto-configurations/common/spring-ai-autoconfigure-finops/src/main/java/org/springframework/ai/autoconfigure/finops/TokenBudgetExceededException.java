 ...
 *
 * <p>
 * This implements the FinOps "light switch" pattern: instead of silently letting token
 * costs accumulate, the application receives an explicit, catchable signal that it can
 * handle with a fallback, circuit-breaker, or alert.
 *
 * <p>
 * Addresses:
 * <ul>
