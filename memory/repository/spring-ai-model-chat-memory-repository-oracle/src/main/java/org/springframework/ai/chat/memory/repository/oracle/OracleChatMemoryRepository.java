...
public final class OracleChatMemoryRepository implements ChatMemoryRepository {
    ...
    private OracleChatMemoryRepository(
            final JdbcChatMemoryRepository delegateRepository) {
    ...
    @Override
    public void saveAll(final String conversationId,
    ...
    public static final class Builder {
         ...
         * @return this builder
         */
        public Builder transactionManager(
                final PlatformTransactionManager transactionManagerToUse) {
