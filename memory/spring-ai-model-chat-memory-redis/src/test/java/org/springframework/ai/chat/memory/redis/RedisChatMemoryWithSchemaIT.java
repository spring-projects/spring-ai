...
/**
 * Integration tests for RedisChatMemory with user-defined metadata schema. Demonstrates
 * how to properly index metadata fields with appropriate types.
 *
...
class RedisChatMemoryWithSchemaIT {
	...
	void shouldFindMessagesByMetadataWithProperSchema() {
		this.contextRunner.run(context -> {
			...
			List<AdvancedChatMemoryRepository.MessageWithConversation> taskMessages = ((AdvancedChatMemoryRepository) chatMemory)
	...
	void shouldFallbackToTextSearchForUndefinedMetadataFields() {
		this.contextRunner.run(context -> {
			...
			List<AdvancedChatMemoryRepository.MessageWithConversation> priorityMessages = ((AdvancedChatMemoryRepository) chatMemory)
			...
			List<AdvancedChatMemoryRepository.MessageWithConversation> customMessages = ((AdvancedChatMemoryRepository) chatMemory)
