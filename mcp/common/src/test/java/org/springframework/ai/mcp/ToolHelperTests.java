...
class ToolHelperTests {
	...
	void constructorShouldBePrivate() throws Exception {
		Constructor<ToolHelper> constructor = ToolHelper.class.getDeclaredConstructor();
	...
	void toSyncToolRegistrationShouldConvertSingleCallback() {
		...
		// Act
		SyncToolRegistration registration = ToolHelper.toSyncToolRegistration(callback);
	...
	void toSyncToolRegistrationShouldConvertMultipleCallbacks() {
		...
		// Act
		List<SyncToolRegistration> registrations = ToolHelper.toSyncToolRegistration(callback1, callback2);
	...
	void toAsyncToolRegistrationShouldConvertSingleCallback() {
		...
		// Act
		AsyncToolRegistration registration = ToolHelper.toAsyncToolRegistration(callback);
	...
	void toAsyncToolRegistrationShouldConvertMultipleCallbacks() {
		...
		// Act
		List<AsyncToolRegistration> registrations = ToolHelper.toAsyncToolRegistration(callback1, callback2);
