...
+
For full documentation, see xref:api/advisors-recursive.adoc#_toolcalladvisor[Recursive Advisors - ToolCallingAdvisor] and xref:api/chatclient.adoc#_tool_calling[ChatClient - Tool Calling].
