...
| spring.ai.openai.image.model        | The model to use for image generation.  | ImageModel.GPT_IMAGE_1_MINI.toString()
...
| spring.ai.openai.image.response_format | The format in which the generated images are returned. Must be one of URL or b64_json. | -
