...
https://ai.meta.com/jurassic/[Meta's Jurassic-2 Chat] is part of the Jurassic-2 collection of large language models.
It excels in dialogue-based applications with a parameter scale of 13 billion.
Leveraging public datasets and human annotations, Jurassic-2 Chat offers context-aware dialogues.

Trained on a diverse set of tokens from public data sources, Jurassic-2 Chat provides extensive knowledge for insightful conversations.
Rigorous testing ensures both performance and safety, making it a reliable choice for AI-driven dialogues.

The https://aws.amazon.com/bedrock/jurassic-2/[AWS Jurassic-2 Model Page] and https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html[Amazon Bedrock User Guide] contains detailed information on how to use the AWS hosted model.
...
=== Enable Jurassic-2 Chat Support
...
TIP: In addition to the model specific https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-bedrock/src/main/java/org/springframework/ai/bedrock/jurassic2/BedrockAi21Jurassic2ChatOptions.java[BedrockAi21Jurassic2ChatOptions] you can use a portable https://github.com/spring-projects/spring-ai/blob/main/spring-ai-core/src/main/java/org/springframework/ai/chat/ChatOptions.java[ChatOptions] instance, created with the https://github.com/spring-projects/spring-ai/blob/main/spring-ai-core/src/main/java/org/springframework/ai/chat/ChatOptionsBuilder.java[ChatOptionsBuilder#builder()].
...
The https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-bedrock/src/main/java/org/springframework/ai/bedrock/jurassic2/BedrockAi21Jurassic2ChatClient.java[BedrockAi21Jurassic2ChatClient] implements the `ChatClient` and `StreamingChatClient` and uses the <<low-level-api>> to connect to the Bedrock Jurassic-2 service.
...
== Low-level Ai21Jurassic2ChatBedrockApi Client [[low-level-api]]

https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-bedrock/src/main/java/org/springframework/ai/bedrock/jurassic2/api/Ai21Jurassic2ChatBedrockApi.java[Ai21Jurassic2ChatBedrockApi] provides a lightweight Java client on top of AWS Bedrock https://docs.aws.amazon.com/bedrock/latest/userguide/model-parameters-jurassic2.html[Meta Jurassic-2 and Jurassic-2 Chat models].

Following class diagram illustrates the Ai21Jurassic2ChatBedrockApi interface and building blocks:

image::bedrock/bedrock-jurassic2-chat-api.jpg[Ai21Jurassic2ChatBedrockApi Class Diagram]

The Ai21Jurassic2ChatBedrockApi supports the `ai21.j2-mid-v1` and `ai21.j2-ultra-v1` models for both synchronous (e.g. `chatCompletion()`) and streaming (e.g. `chatCompletionStream()`) responses.
...
// Streaming response
Flux<Ai21Jurassic2ChatResponse> responseStream = jurassic2ChatApi.chatCompletionStream(request);
List<Ai21Jurassic2ChatResponse> responses = responseStream.collectList().block();
----
