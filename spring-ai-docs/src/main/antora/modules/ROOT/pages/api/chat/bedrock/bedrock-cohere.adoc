...
| spring.ai.bedrock.cohere.chat.model                | The model id to use. See the https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-bedrock/src/main/java/org/springframework/ai/bedrock/cohere/BedrockCohereChatModel.java[CohereChatModel] for the supported models.  | `cohere.command-text-v14`
...
Look at the https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-bedrock/src/main/java/org/springframework/ai/bedrock/cohere/BedrockCohereChatModel.java[CohereChatModel] for other model IDs.
...
BedrockCohereChatModel chatModel = new BedrockCohereChatModel(converseApi,
	    BedrockCohereChatOptions.builder()
