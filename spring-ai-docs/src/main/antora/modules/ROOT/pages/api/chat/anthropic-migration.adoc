...
* Skills, built-in web search, service tier, inference geo, and structured output as `AnthropicChatOptions` fields, all bindable from `spring.ai.anthropic.chat.options.*`.
