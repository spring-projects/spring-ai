...
| spring.ai.oci.genai.connect-timeout | HTTP connection timeout | -
| spring.ai.oci.genai.read-timeout | HTTP read timeout | -
| spring.ai.oci.genai.max-async-threads | Maximum number of async threads | -
|====
