...
image::tools/tool-context.png[Providing additional contextual info to tools, width=700, align="center"]
...
image::tools/return-direct.png[Returning tool call results directly to the caller, width=700, align="center"]
...
image::tools/framework-manager.png[Framework-controlled tool execution lifecycle, width=700, align="center"]
