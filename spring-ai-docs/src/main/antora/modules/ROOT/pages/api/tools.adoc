...
- `continuousStream`: Whether, in streaming mode and when internal tool execution is enabled, the model should continue its response after the tool execution result is sent back.
