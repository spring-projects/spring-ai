...
Groq supports https://console.groq.com/docs/tool-use[tool calling] when the selected model supports it. Spring AI handles the tool execution loop.

TIP: Check the https://console.groq.com/docs/tool-use[supported models].
