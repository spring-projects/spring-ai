...
[source,shell]
----
export SPRING_AI_GROQ_API_KEY=<INSERT GROQ API KEY HERE>
export SPRING_AI_GROQ_BASE_URL=https://api.groq.com/openai
export SPRING_AI_GROQ_CHAT_MODEL=llama3-70b-8192
----
...
----
spring.ai.openai.api-key=<SPRING_AI_GROQ_API_KEY>
...
var openAiApi = OpenAiApi.builder()
        ...
        .apiKey(System.getenv("SPRING_AI_GROQ_API_KEY"))
        .build();
...
var chatModel = OpenAiChatModel.builder()
        ...
        .defaultOptions(this.openAiChatOptions)
        .build();
