...
- xref:api/structured-output/native.adoc#_provider_built_in_json_mode[Built-in JSON]: Native support for JSON output.
...
| xref::api/chat/deliverance-chat.adoc[Deliverance] | text ^a| image::yes.svg[width=16] ^a| image::yes.svg[width=16] ^a| image::no.svg[width=12] ^a| image::no.svg[width=12] ^a| image::yes.svg[width=16] ^a| image::yes.svg[width=16] ^a| image::no.svg[width=12]
...
| xref::api/chat/minimax-chat.adoc[MiniMax (Anthropic-proxy)]  | text, image ^a| image::yes.svg[width=16] ^a| image::yes.svg[width=16] ^a| image::yes.svg[width=16] ^a| image::yes.svg[width=16] ^a| image::no.svg[width=12] ^a| image::no.svg[width=12] ^a| image::yes.svg[width=16]
...
| xref::api/chat/openai-responses-chat.adoc[OpenAI Responses API]  a| In: text, image, pdf
Out: text, image ^a| image::yes.svg[width=16] ^a| image::yes.svg[width=16] ^a| image::yes.svg[width=16] ^a| image::yes.svg[width=16] ^a| image::yes.svg[width=16] ^a| image::no.svg[width=12] ^a| image::no.svg[width=12]
