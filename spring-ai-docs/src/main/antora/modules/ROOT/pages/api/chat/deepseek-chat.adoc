...
| spring.ai.deepseek.chat.model | ID of the model to use. You can use deepseek-chat, deepseek-reasoner, deepseek-v4-flash, or deepseek-v4-pro. | deepseek-chat
...
ChatResponse response = chatModel.call(
    new Prompt(
        ...
        DeepSeekChatOptions.builder()
            .withModel(DeepSeekApi.ChatModel.DEEPSEEK_V4_FLASH.getValue())
