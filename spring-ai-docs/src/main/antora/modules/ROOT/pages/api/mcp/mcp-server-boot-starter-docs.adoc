...
|===
|Server Type | Dependency | Property
| xref:api/mcp/mcp-stdio-sse-server-boot-starter-docs.adoc#_sse_webmvc_server[SSE WebMVC] _(deprecated since 2.0.0, use STREAMABLE instead)_ | `spring-ai-starter-mcp-server-webmvc` | `spring.ai.mcp.server.protocol=SSE`
...
|===
|Server Type | Dependency | Property
| xref:api/mcp/mcp-stdio-sse-server-boot-starter-docs.adoc#_sse_webflux_server[SSE WebFlux] _(deprecated since 2.0.0, use STREAMABLE instead)_ | `spring-ai-starter-mcp-server-webflux` | `spring.ai.mcp.server.protocol=SSE`
