...
* **Tools** - Allows servers to expose tools that can be invoked by language models. Note that all available tools in the application context are published as MCP tools, including tools obtained from MCP clients.
