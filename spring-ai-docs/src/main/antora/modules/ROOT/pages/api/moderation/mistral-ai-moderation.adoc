...
| spring.ai.mistralai.moderation.model  | ID of the model to use for moderation. | mistral-moderation-latest
|====
...
TIP: All properties prefixed with `spring.ai.mistralai.moderation` can be overridden at runtime.
