...
|`spring.ai.vectorstore.typesense.protocol`| HTTP Protocol | `http`
|`spring.ai.vectorstore.typesense.host`| Hostname | `localhost`
|`spring.ai.vectorstore.typesense.port`| Port | `8108`
|`spring.ai.vectorstore.typesense.apiKey`| ApiKey | `xyz`
