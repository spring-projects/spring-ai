...
TIP: All properties prefixed with `spring.ai.openai.audio.speech` can be overridden at runtime.
...
* The link:https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-openai/src/test/java/org/springframework/ai/openai/audio/OpenAiAudioSpeechModelIT.java[OpenAiAudioSpeechModelIT.java] test provides some general examples of how to use the library.
