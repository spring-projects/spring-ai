...
| spring.ai.azure.openai.connect-timeout | HTTP connection timeout | -
| spring.ai.azure.openai.read-timeout | HTTP read timeout | -
| spring.ai.azure.openai.write-timeout | HTTP write timeout | -
| spring.ai.azure.openai.response-timeout | HTTP response timeout | -
| spring.ai.azure.openai.maximum-connection-pool-size | Maximum number of connections in the HTTP connection pool | -
|====
