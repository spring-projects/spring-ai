...
| spring.ai.google.genai.image.model | The https://docs.cloud.google.com/gemini-enterprise-agent-platform/models[Google GenAI model] to use. Supported models include `gemini-2.5-flash-image`, `gemini-3-pro-image` and `gemini-3.1-flash-image` | gemini-2.5-flash-image
| spring.ai.google.genai.image.aspect-ratio | The aspect ratio of the generated images. Supported values are 1:1, 2:3, 3:2, 3:4, 4:3, 9:16, 16:9, and 21:9 | 1:1
| spring.ai.google.genai.image.seed | Random seed for image generation. By default, a random number is used. | -
...
| spring.ai.google.genai.image.prominent-people | Allows generation of images of prominent (well-known) people by the model. Supported values are ALLOW_PROMINENT_PEOPLE and BLOCK_PROMINENT_PEOPLE. | -
...
| spring.ai.google.genai.image.image-size | The size of the largest dimension of the generated image. Supported sizes are 1K, 2K, and 4K. | 1K
...
The Google GenAI image API allows the model to control the generation of images depicting well-known (prominent) people:

- `ALLOW_PROMINENT_PEOPLE`: Allow generation of images depicting prominent people
- `BLOCK_PROMINENT_PEOPLE`: Block generation of images depicting prominent people
- `PROMINENT_PEOPLE_UNSPECIFIED`: Threshold is unspecified, use the default behavior
