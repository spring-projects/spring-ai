...
| spring.ai.google.genai.image.options.safety-filter-level | Filter level for safety filtering. | -
| spring.ai.google.genai.image.options.person-generation | Allows generation of people by the model. | -
