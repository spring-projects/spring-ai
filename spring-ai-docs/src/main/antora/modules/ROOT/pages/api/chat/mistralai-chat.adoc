...
`MistralAiChatModel` supports tool calling. The model can request tool execution but does not run tools itself — Spring AI handles execution.
...
For more information about structured outputs, see the xref:api/structured-output.adoc[Structured Output] documentation.
