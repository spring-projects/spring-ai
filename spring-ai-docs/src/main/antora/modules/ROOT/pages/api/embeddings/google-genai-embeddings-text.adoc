...
If you were previously using the Vertex AI Text Embeddings implementation (`spring-ai-vertex-ai-embedding`), which has been removed, migrate to Google GenAI:
