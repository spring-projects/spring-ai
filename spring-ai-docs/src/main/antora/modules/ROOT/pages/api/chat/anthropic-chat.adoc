...
* **xref:api/tools.adoc#_chatclient_tool_execution[ChatClient with ToolCallingAdvisor]** — the recommended approach for most use cases. `ToolCallingAdvisor` is automatically registered and manages the tool-call loop transparently.
