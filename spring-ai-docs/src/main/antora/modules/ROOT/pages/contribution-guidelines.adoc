...
`RestClient` class from the Spring Framework, similar to the `MistralAiApi` class.
...
When logging Personally Identifiable Information (PII), mark it with https://github.com/spring-projects/spring-ai/blob/main/spring-ai-commons/src/main/java/org/springframework/ai/util/LoggingMarkers.java[`PII_MARKER`] Slf4j marker.
