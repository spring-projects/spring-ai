...
|`error.type` | The canonical class name of the exception the operation ended with, or its binary name when it has no canonical name. Only present when the operation failed.
