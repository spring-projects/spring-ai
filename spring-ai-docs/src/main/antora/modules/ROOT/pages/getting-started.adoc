...
Spring AI can be used in non-web console applications without requiring a web server.
A web starter dependency is not required for simple command-line applications.

No `spring-boot-starter-web` dependency is required.
...
public class ConsoleApplication implements CommandLineRunner {
    ...
    public ConsoleApplication(ChatClient.Builder builder) {
