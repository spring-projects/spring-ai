...
This section covers all breaking changes and migration steps when upgrading from Spring AI 1.x to 2.0.0.
The changes are organized thematically — each subsection is self-contained and can be read independently.
