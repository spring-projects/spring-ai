...
----
// Before
ServerMcpTransport transport = new WebFluxSseServerTransport(jsonMapper, "/mcp/message");
var server = McpServer.sync(transport)
    .serverInfo("my-server", "1.0.0")
    .build();

// After
McpServerTransportProvider transportProvider = new WebFluxSseServerTransportProvider(jsonMapper, "/mcp/message");
