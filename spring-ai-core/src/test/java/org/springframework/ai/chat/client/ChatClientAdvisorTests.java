...
public class ChatClientAdvisorTests {
	...
	// @Override
	// public AdvisedRequest adviseRequest(AdvisedRequest request, Map<String, Object>
	// context) {
	...
	// @Override
	// public ChatResponse adviseResponse(ChatResponse response, Map<String, Object>
	// context) {
	...
	// John")))))
	// .thenReturn(new ChatResponse(List.of(new Generation(new AssistantMessage("Your name
	// is John")))));
	...
	// assertThat(mockAdvisor.advisedRequest.advisorParams()).containsEntry("key1",
	// "value1")
	// .containsEntry("key2", "value2")
