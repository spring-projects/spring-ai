...
public class HistoryChatClientTests {
	...
	public void chatClientUserMessages() {
		...
		ChatResponse response1 = historyChatClient
		...
		ChatResponse response3 = historyChatClient.call(new Prompt(List.of(new UserMessage("user:9"))));
	...
	public void chatClientUserAndSystemMessages() {
		...
		ChatResponse response1 = historyChatClient.call(
				new Prompt(List.of(new SystemMessage("system:1"), new UserMessage("user:1"), new UserMessage("user:2"),
		...
		ChatResponse response3 = historyChatClient.call(new Prompt(List.of(new SystemMessage("system:2"))));
	...
	public void streamChatClientUserMessages() {
		...
		when(streamingChatClient.stream(promptCaptor.capture()))
			.thenReturn(Flux.just(new ChatResponse(List.of(new Generation("as"))),
					new ChatResponse(List.of(new Generation("sis"))), new ChatResponse(List.of(new Generation("tant"))),
					new ChatResponse(List.of(new Generation(":1")))))
			.thenReturn(Flux.just(new ChatResponse(List.of(new Generation("as"))),
					new ChatResponse(List.of(new Generation("sis"))), new ChatResponse(List.of(new Generation("ta"))),
					new ChatResponse(List.of(new Generation("nt:2")))))
			.thenReturn(Flux.just(new ChatResponse(List.of(new Generation("assi"))),
					new ChatResponse(List.of(new Generation("s"))), new ChatResponse(List.of(new Generation("tant"))),
					new ChatResponse(List.of(new Generation(":3")))));

		Flux<ChatResponse> response1 = historyChatClient
			.stream(new Prompt(List.of(new UserMessage("user:1"), new UserMessage("user:2"), new UserMessage("user:3"),
					new UserMessage("user:4"), new UserMessage("user:5"))));
		...
		Flux<ChatResponse> response3 = historyChatClient.stream(new Prompt(List.of(new UserMessage("user:9"))));
