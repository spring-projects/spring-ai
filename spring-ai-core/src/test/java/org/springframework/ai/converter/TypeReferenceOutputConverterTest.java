...
class TypeReferenceOutputConverterTest {
	...
	public void shouldHavePreConfiguredDefaultObjectMapper() {
		var converter = new TypeReferenceOutputConverter<>(new TypeReference<TestClass>() {
		});
	...
	class ParserTest {
		...
		public void shouldParseFieldNamesFromArrayString() {
			var converter = new TypeReferenceOutputConverter<>(new TypeReference<List<TestClass>>() {
			});
		...
		public void shouldParseJsonPropertiesFromString() {
			var converter = new TypeReferenceOutputConverter<>(new TypeReference<TestClassWithJsonAnnotations>() {
			});
		...
		public void shouldParseJsonPropertiesFromArrayString() {
			var converter = new TypeReferenceOutputConverter<>(new TypeReference<List<TestClassWithJsonAnnotations>>() {
			});
