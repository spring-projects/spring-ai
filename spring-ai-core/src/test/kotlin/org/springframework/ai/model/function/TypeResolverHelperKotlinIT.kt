...
class TypeResolverHelperKotlinIT {
	...
	fun beanInputTypeResolutionTest(beanName: String) {
		...
		val beanDefinition = this.applicationContext.getBeanDefinition(beanName)
		val beanType = beanDefinition.resolvableType.type
		val functionInputClass = TypeResolverHelper.getFunctionArgumentType(beanType, 0).rawClass;
