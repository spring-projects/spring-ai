...
class JdbcChatMemoryAutoConfigurationIT {
	...
	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
		...
		.withPropertyValues(String.format("spring.datasource.username=%s", postgresContainer.getUsername()))
		.withPropertyValues(String.format("spring.datasource.password=%s", postgresContainer.getPassword()))
