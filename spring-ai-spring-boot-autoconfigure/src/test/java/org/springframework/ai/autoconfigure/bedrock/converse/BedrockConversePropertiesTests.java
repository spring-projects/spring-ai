 ...
 */
public class BedrockConversePropertiesTests {
	...
	public void chatOptionsTest() {
		...
		// @formatter:off
				"spring.ai.bedrock.converse.chat.timeout=4m",	
			...
			.run(context -> {
				...
				assertThat(chatProperties.getTimeout()).isEqualTo(Duration.ofMinutes(4));
