...
public class PineconeVectorStoreAutoConfigurationIT {
	...
	List<Document> documents = List.of(
			new Document("1", ResourceUtils.getText("classpath:/test/data/spring.ai.txt"), Map.of("spring", "great")),
			new Document("2", ResourceUtils.getText("classpath:/test/data/time.shelter.txt"), Map.of()),
			new Document("3", ResourceUtils.getText("classpath:/test/data/great.depression.txt"),
					Map.of("depression", "bad")));
