...
import org.springframework.ai.autoconfigure.bedrock.cohere.tool.MockWeatherService.Request;
import org.springframework.ai.autoconfigure.bedrock.cohere.tool.MockWeatherService.Response;
	...
	void functionCallTest() {
		...
		contextRunner.run(context -> {
			...
			ChatResponse response = chatModel.call(new Prompt(List.of(userMessage),
					BedrockCohereCommandRChatOptions.builder().withFunction("weatherFunction").build()));
