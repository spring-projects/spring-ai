		...
		contextRunner.withPropertyValues("spring.ai.openai.chat.options.model=gpt-4-1106-preview").run(context -> {
			...
			var promptOptions = OpenAiChatOptions.builder()
				.withToolCallbacks(List
					.of(new AbstractToolFunctionCallback<FakeWeatherService.Request, FakeWeatherService.Response>(
			...
			ChatResponse response = chatClient.call2(new Prompt(messages, promptOptions));
