...
package org.springframework.ai.autoconfigure.deepseek.tool;
...
import org.springframework.ai.autoconfigure.deepseek.DeepSeekAutoConfiguration;
	...
	void functionCallTest() {
		this.contextRunner.run(context -> {
			...
			ChatResponse response = chatModel
				.call(new Prompt(List.of(userMessage), DeepSeekChatOptions.builder().function("WeatherInfo").build()));
	...
	void streamFunctionCallTest() {
		this.contextRunner.run(context -> {
			...
			Flux<ChatResponse> response = chatModel.stream(
					new Prompt(List.of(userMessage), DeepSeekChatOptions.builder().function("WeatherInfo").build()));
