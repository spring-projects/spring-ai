...
/**
 * Unit Tests for {@link MistralAiConnectionProperties},
 * {@link MistralAiEmbeddingProperties}.
 */
	...
	public void embeddingProperties() {
		...
		new ApplicationContextRunner()
			...
			.run(context -> {
				...
				var connectionProperties = context.getBean(MistralAiConnectionProperties.class);
