 ...
 * Disable this with the {@link CassandraVectorStoreConfig#disallowSchemaChanges()}.
 *
 ...
 * {@link CassandraVectorStoreConfig#withFixedThreadPoolExecutorSize(int)} accordingly to
 * improve performance so embeddings are created and the documents are added concurrently.
 * The default concurrency is 16
