...
/**
 * Converts {@link Expression} into Valkey search filter expression format.
 * (<a href= "https://valkey.io/topics/search/">search</a>)
 *
 * @author Julien Ruaux
 * @author Vasile Gorcinschi
 */
public class ValkeyFilterExpressionConverter extends AbstractFilterExpressionConverter {
	...
	public ValkeyFilterExpressionConverter(List<MetadataField> metadataFields) {
