 ...
 */
class ValkeyFilterExpressionConverterTests {

	private static ValkeyFilterExpressionConverter converter(MetadataField... fields) {
		return new ValkeyFilterExpressionConverter(Arrays.asList(fields));
	}

	@Test
	void testEQ() {
		// country == "BG"
		String vectorExpr = converter(ValkeyVectorStore.MetadataField.tag("country"))
	...
	void tesEqAndGte() {
		...
		String vectorExpr = converter(ValkeyVectorStore.MetadataField.tag("genre"),
				ValkeyVectorStore.MetadataField.numeric("year"))
	...
	void tesIn() {
		...
		String vectorExpr = converter(ValkeyVectorStore.MetadataField.tag("genre")).convertExpression(
	...
	void testNe() {
		...
		String vectorExpr = converter(ValkeyVectorStore.MetadataField.numeric("year"),
				ValkeyVectorStore.MetadataField.tag("country"), ValkeyVectorStore.MetadataField.tag("city"))
	...
	void tesBoolean() {
		...
		String vectorExpr = converter(ValkeyVectorStore.MetadataField.numeric("year"),
				ValkeyVectorStore.MetadataField.tag("country"), ValkeyVectorStore.MetadataField.tag("isOpen"))
			.convertExpression(new Expression(AND,
	...
	void testDecimal() {
		...
		String vectorExpr = converter(ValkeyVectorStore.MetadataField.numeric("temperature"))
	...
	void testComplexIdentifiers() {
		String vectorExpr = converter(ValkeyVectorStore.MetadataField.tag("country 1 2 3"))
			.convertExpression(new Expression(EQ, new Key("\"country 1 2 3\""), new Value("BG")));
		assertThat(vectorExpr).isEqualTo("@\"country 1 2 3\":{BG}");

		vectorExpr = converter(ValkeyVectorStore.MetadataField.tag("country 1 2 3"))
			.convertExpression(new Expression(EQ, new Key("'country 1 2 3'"), new Value("BG")));
		assertThat(vectorExpr).isEqualTo("@'country 1 2 3':{BG}");
	}
	...
	void testSpecialCharactersInValues() {
		...
		String vectorExpr = converter(ValkeyVectorStore.MetadataField.tag("description"))
	...
	void testEmptyStringValues() {
		String vectorExpr = converter(ValkeyVectorStore.MetadataField.tag("status"))
	...
	void testWhitespaceInFieldNames() {
		String vectorExpr = converter(ValkeyVectorStore.MetadataField.tag("value with spaces"))
	...
	void testNestedQuotedFieldNames() {
		String vectorExpr = converter(ValkeyVectorStore.MetadataField.tag("value \"with\" quotes"))
