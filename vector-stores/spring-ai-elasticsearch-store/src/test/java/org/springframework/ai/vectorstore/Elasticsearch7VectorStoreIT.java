...
class Elasticsearch7VectorStoreIT extends BaseElasticsearchVectorStoreIT {

    @Container
    private static final ElasticsearchContainer elasticsearchContainer =
            new ElasticsearchContainer("docker.elastic.co/elasticsearch/elasticsearch:7.17.16").withEnv(
