...
class ElasticsearchAiSearchFilterExpressionConverterTest {
    ...
    public void testDate() {
        ...
        vectorExpr = converter
                .convertExpression(new Filter.Expression(EQ, new Filter.Key("activationDate"),
    ...
    public void tesEqAndGte() {
        String vectorExpr = converter
                .convertExpression(new Filter.Expression(AND,
    ...
    public void tesIn() {
        String vectorExpr = converter.convertExpression(
                new Filter.Expression(IN, new Filter.Key("genre"),
    ...
    public void testNe() {
        String vectorExpr = converter
                .convertExpression(new Filter.Expression(OR,
                        new Filter.Expression(GTE, new Filter.Key("year"), new Filter.Value(2020)),
    ...
    public void testComplexIdentifiers() {
        String vectorExpr = converter
                .convertExpression(
                        new Filter.Expression(EQ, new Filter.Key("\"country 1 2 3\""), new Filter.Value("BG")));
