...
public class InfinispanVectorStore extends AbstractObservationVectorStore implements InitializingBean {
	...
	private RemoteCache<String, SpringAiInfinispanItem> remoteCache;
	...
	public void afterPropertiesSet() {
		...
		infinispanClient.getConfiguration().addRemoteCache(this.storeName, c -> {
			c.marshaller(finalMarshaller);
		});
