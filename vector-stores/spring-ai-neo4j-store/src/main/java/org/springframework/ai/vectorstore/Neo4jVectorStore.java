...
public class Neo4jVectorStore implements VectorStore, InitializingBean {
	...
	public enum Neo4jDistanceType {
		...
		CosineDistance("cosine"), EuclideanDistance("euclidean");
	...
	public static final class Neo4jVectorStoreConfig {
		...
		public static class Builder {
			...
			private Neo4jDistanceType distanceType = Neo4jDistanceType.CosineDistance;
	...
	private Map<String, Object> documentToRecord(Document document) {
		...
		row.put("embedding", Values.value(toFloatArray(embedding)));
		return row;
	}
	...
	private static Document recordToDocument(org.neo4j.driver.Record record) {
