	...
	void observationVectorStoreAddAndQueryOperations() {
		...
		contextRunner.run(context -> {
			...
			TestObservationRegistryAssert.assertThat(observationRegistry)
				...
				.that()
				.hasContextualNameEqualTo("vector_store milvus_vector_store add")
				.hasLowCardinalityKeyValue(LowCardinalityKeyNames.DB_OPERATION_NAME.asString(), "add")
				.hasLowCardinalityKeyValue(LowCardinalityKeyNames.DB_SYSTEM.asString(), "milvus_vector_store")
			...
			TestObservationRegistryAssert.assertThat(observationRegistry)
				...
				.hasObservationWithNameEqualTo(DefaultVectorStoreObservationConvention.DEFAULT_NAME)
				.that()
				.hasContextualNameEqualTo("vector_store milvus_vector_store query")
