...
public class ToolCallAdvisor implements CallAdvisor, StreamAdvisor {
	...
	public static class Builder<T extends Builder<T>> {
		...
		/**
		 * Sets whether internal conversation history is enabled. If false you need an
		 * ChatMemmory Advisor registered next in the chain.
		 * @param internalConversationHistoryEnabled true to enable, false to disable
		 * @return this Builder instance for method chaining
		 */
