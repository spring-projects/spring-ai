...
public class ChatClientNativeStructuredResponseTests {
	...
	@Test
	public void nativeResponseEntityTest(@Captor ArgumentCaptor<String> outputSchemaCaptor) throws JSONException {
		...
		JSONAssert.assertEquals(USER_JSON_SCHEMA, outputSchemaCaptor.getValue(), JSONCompareMode.NON_EXTENSIBLE);
	}

	@Test
	public void nativeEntityTest(@Captor ArgumentCaptor<String> outputSchemaCaptor) throws JSONException {
